...
public class MultipartEntityBuilderTest {
	...
	public static void main(String args[]) {
		String envAttr = "{\n" + "\"NOTIFY\": [" + "\"/generic-service/batch/updateStatoFatture/envelope/200/636\""
		...
		String docMeta = "{"
				...
				+ "\"dct-meta::data_documento\": \"12/03/2019\"," + "\"dct-meta::data_ric_sdi\": \"11/03/2019\","
				+ "\"dct-meta::nome_allegato\": \"nome_allegato_123\"," + "\"dct-meta::nota\": \"nota_123\","
		...
		String docAttr = "{" + "\"estensione\": \"pdf\"," + "\"fileToSend\": \"e:\\fatturazione\\work\\1223\\\","
				+ "\"mimeType\": \"application/pdf\"," + "\"nomeDocumento\": \"fattura-123.pdf\"" + "}";
		...
		builder.addPart("doc-attr-" + docFileName,
				new ByteArrayBody(docAttr.getBytes(), "doc-attr-" + docFileName + ".json"));
		builder.addPart("doc-meta-" + docFileName,
				new ByteArrayBody(docMeta.getBytes(), "doc-meta-" + docFileName + ".json"));
